 ...
 * @author kislay.verma
 */
public class OrderCancellationCouponMissingCategoryBuilder {
    ...
    public static String build(String requestText) throws Exception {
        ...
        if (orderId == null) {
            return "You request (lacking order id) has been recorded with id OrderCancellationCouponMissingRequest" + TICKET_ID++ + ". Please provide the order id for faster resolution of the issue";
        }
        return "You request has been recorded with id OrderCancellationCouponMissingRequest" + TICKET_ID++;
    }
