 ...
 * @author kislay.verma
 */
public class OrderIdExtractionModel {

    private static NameFinderME nameFinder;
    private static boolean INITIALIZED = false;
    private static final String onlpModelPath = "/Users/kislay.verma/classifier/order-id-model";
    private static final String trainingDataFilePath = "/Users/kislay.verma/classifier/order-id-extraction-dataset.txt";

    public static void main(String[] args) throws InvalidFormatException,
            IOException {
        System.out.println(OrderIdExtractionModel.getOrderId(
            "What is order id 700001 status"));
    }

    public static String getOrderId(String input) throws IOException {
        if (!INITIALIZED) {
            init();
        }
        ...
        for (String sentence : sentences) {
            ...
            if (spanArr != null && spanArr.length > 0) {
                ...
                System.out.println("Original order id extracted " + b.toString());
                String finalOrderID = b.toString().replaceAll("[^\\d]", "");
    ...
    public static void init() throws IOException {
        ...
        try {
            model = NameFinderME.train("en", "orderId", sampleStream, null);
